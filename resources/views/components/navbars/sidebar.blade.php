...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            <img src="{{ asset('assets') }}/img/logos/asasasasa.jpg" class="navbar-brand-img h-200" alt="main_logo">
            <span class="ms-2 font-weight-bold text-white">Bright Boost</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (auth()->user()->hasRole('administrator') || auth()->user()->hasRole('superadministrator'))
                ...
                <li class="nav-item">
                    <a class="nav-link text-white {{ $activePage == 'courses' ? ' active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'threads' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('threads.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">dashboard</i>
                    </div>
                    <span class="nav-link-text ms-1">My Discussions</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'lectures' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('lecture-tutors.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">dashboard</i>
                    </div>
                    <span class="nav-link-text ms-1">My Lectures</span>
                </a>
            </li>
            @endif
