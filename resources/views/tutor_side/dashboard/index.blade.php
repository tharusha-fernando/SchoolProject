                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            @if (isset($lecs->Monday) && is_object($lecs->Monday) && isset($lecs->Monday->course))
                                                                <h6 class="mb-0 text-sm">
                                                                    <a href="{{route('lecture-tutors.edit', ['lecture_tutor' => $lecs->Monday->id])}}"> {{ $lecs->Monday->course->course_name }}</a></h6>
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            ...
                                                            <h6 class="mb-0 text-sm">
                                                                <a href="{{route('lecture-tutors.edit', ['lecture_tutor' => $lecs->Tuesday->id])}}">  {{ $lecs->Tuesday->course->course_name }}</a></h6>
                                                            <h6 class="mb-0 text-sm"> By
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            ...
                                                            <h6 class="mb-0 text-sm">
                                                                <a href="{{route('lecture-tutors.edit', ['lecture_tutor' => $lecs->Wednesday->id])}}">  {{ $lecs->Wednesday->course->course_name }}</a></h6>
                                                            <h6 class="mb-0 text-sm"> By
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            ...
                                                            <h6 class="mb-0 text-sm">
                                                                <a href="{{route('lecture-tutors.edit', ['lecture_tutor' => $lecs->Thursday->id])}}"> {{ $lecs->Thursday->course->course_name }}</a></h6>
                                                            <h6 class="mb-0 text-sm"> By
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            ...
                                                            <h6 class="mb-0 text-sm">
                                                                <a href="{{route('lecture-tutors.edit', ['lecture_tutor' => $lecs->Friday->id])}}"> {{ $lecs->Friday->course->course_name }}</a></h6>
                                                            <h6 class="mb-0 text-sm"> By
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            ...
                                                            <h6 class="mb-0 text-sm">
                                                                <a href="{{route('lecture-tutors.edit', ['lecture_tutor' => $lecs->Saturday->id])}}">  {{ $lecs->Saturday->course->course_name }}</a></h6>
                                                            <h6 class="mb-0 text-sm"> By
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            ...
                                                            <h6 class="mb-0 text-sm">
                                                               <a href="{{route('lecture-tutors.edit', ['lecture_tutor' => $lecs->Sunday->id])}}"> {{ $lecs->Sunday->course->course_name }}</a></h6>
                                                            <h6 class="mb-0 text-sm"> By
