                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body px-0 pb-2 m-2 border rounded">
                            <div class=" me-3 my-3 text-end">
                                <a class="btn bg-gradient-dark mb-0" href="{{ route('lecture-tutors.create') }}"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", ".deleteBtn", function() {
                ...
                var url =
                    '{{ route('lecture-tutors.destroy', ['lecture_tutor' => '__lectureId']) }}'
            ...
            var table = $('#lecturesDataTable').DataTable({
                ...
                'pageLength': 15,
                'ajax': {
                    'url': "{{ route('lectures-tutors.getData') }}",
