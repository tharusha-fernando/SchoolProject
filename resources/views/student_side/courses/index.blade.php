<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    <x-navbars.sidebar activePage="mycourses"></x-navbars.sidebar>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", ".addBtn", function() {
                var courseId = $(this).data('id');
                var url =
                    '{{ route('my-courses.store', ['course' => '__courseId']) }}'
                    .replace('__courseId', courseId);
                ...
                var confirmDelete = confirm("Are you sure you want to add?");

                if (confirmDelete) {

                    addCourse(url, table, courseId);
                }
